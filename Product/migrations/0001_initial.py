# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-02-06 10:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200, unique=True, verbose_name='Cat_name')),
                ('slug', models.SlugField(help_text='Unique value for product page URL, created from name.', unique=True, verbose_name='Cat_URL')),
                ('description', models.TextField()),
                ('is_active', models.BooleanField(default=True)),
                ('meta_keyword', models.CharField(help_text='Comma-delimited set of SEO keywords for meta tag', max_length=255, verbose_name='Keywords')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=60, verbose_name='Product')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('catogories', models.ManyToManyField(to='Product.Category')),
            ],
            options={
